    ...
    <div className="relative mt-8 flex w-full flex-col items-center">
      ...
      >
        <div className="relative h-60 w-full [perspective:1200px]">
          ...
          <div className="absolute left-1/2 top-0 z-40 w-[88%] max-w-[320px] -translate-x-1/2 sm:-top-2 sm:w-[82%] sm:max-w-none">
            <motion.div
              className="w-full rounded-[24px] border border-softGold/30 bg-ivory/95 px-5 py-7 text-center shadow-xl sm:rounded-[26px] sm:px-6 sm:py-8"
