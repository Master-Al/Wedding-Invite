...
export default function RSVPForm() {
  ...
  const [isRsvpOpen, setIsRsvpOpen] = useState<boolean | null>(null);


  useEffect(() => {
    const now = new Date();
    const cutoff = new Date("2026-04-06T23:59:59");
      ...
      <div className="relative mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <p className="mt-4 text-base text-burgundy/70 sm:text-lg">
            Your presence would mean the world. Save your seats by April 6,
            2026.
          </p>
        </div>

        {isRsvpOpen === false ? (
          <div className="lux-card mt-12 rounded-[40px] bg-sage/30 p-8 text-center shadow-candle-soft">
            <p className="text-base text-burgundy/80">
              RSVPs are now closed. Thank you for your love and support.
            </p>
          </div>
        ) : (
          <motion.form
