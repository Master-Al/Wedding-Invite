      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        {petals.map((petal, index) => (
          <span
            ...
            style={{ left: petal.left, top: petal.top, animationDelay: petal.delay, animationDuration: petal.duration }}
          />
        ))}
      </div>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 py-24">
        <div className="lux-card menu-frame w-full max-w-5xl rounded-[48px] border border-softGold/40 bg-ivory/70 px-6 py-12 shadow-gold-soft sm:px-12">
          <div className="text-center">
            <p className="lux-heading text-xs tracking-[0.4em] text-burgundy/70">A celebration of love</p>
            <h1 className="mt-4 text-4xl font-semibold text-burgundy sm:text-6xl">Al & Joan</h1>
            <p className="mt-4 text-base text-burgundy/70 sm:text-lg">
              A candlelit restaurant celebration awaits. Tap the envelope to begin.
            </p>
          </div>
